export const DEFAULT_FIXED_TASKS = [
  ...
  { id: 'f3', time: '22:00', label: 'Tempo em família',    pillar: 'familia',    fixed: true },
]
...
export const TASK_SUGGESTIONS = {
  ...
  familia:    ['Tempo em família', 'Atividade com os filhos', 'Estudo bíblico em família', 'Jantar em família', 'Momento a dois'],
